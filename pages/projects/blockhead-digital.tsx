...
const layout = [
  ...
  { i: "d", x: 2, y: 0, w: 1, h: 2, img: cube },
  { i: "e", x: 3, y: 0, w: 1, h: 2, img: mobile },
];
...
const BlockheadDigital = () => {
  ...
  return (
    <>
      <button
        onClick={() => router.push("/")}
        className="transition ease-in-out p-3 hover:scale-110 bg-gray-200 max-w-fit rounded-full absolute top-10 left-1/2 -translate-x-1/2 "
      >
        ...
        <div className="grid grid-cols-2 gap-10">
          ...
          <div>
            <p className="mb-3">
              ...
              ipsum dolor sit. Lorem ipsum dolor sit. Lorem ipsum dolor sit.
              Lorem ipsum dolor sit. Lorem ipsum dolor sit. Lorem ipsum dolor
              sit. Lorem ipsum dolor sit. Lorem ipsum dolor sit.
            </p>
            <p className="">
              Lorem ipsum dolor sit. Lorem ipsum dolor sit. Lorem ipsum dolor
              sit. Lorem ipsum dolor sit. Lorem ipsum dolor sit. Lorem ipsum
